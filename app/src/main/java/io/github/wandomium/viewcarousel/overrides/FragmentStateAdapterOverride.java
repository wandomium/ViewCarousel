package io.github.wandomium.viewcarousel.overrides;
 ...
 * </ul>
 */
public abstract class FragmentStateAdapterOverride extends
        RecyclerView.Adapter<FragmentViewHolderOverride> implements StatefulAdapter {
    ...
    private FragmentStateAdapterOverride.FragmentMaxLifecycleEnforcer mFragmentMaxLifecycleEnforcer;
     ...
     *
     * @see FragmentStateAdapterOverride#FragmentStateAdapterOverride(Fragment)
     * @see FragmentStateAdapterOverride#FragmentStateAdapterOverride(FragmentManager, Lifecycle)
     */
    public FragmentStateAdapterOverride(@NonNull FragmentActivity fragmentActivity) {
     ...
     *
     * @see FragmentStateAdapterOverride#FragmentStateAdapterOverride(FragmentActivity)
     * @see FragmentStateAdapterOverride#FragmentStateAdapterOverride(FragmentManager, Lifecycle)
     */
    public FragmentStateAdapterOverride(@NonNull Fragment fragment) {
     ...
     * @see FragmentStateAdapterOverride#FragmentStateAdapterOverride(Fragment)
     */
    public FragmentStateAdapterOverride(@NonNull FragmentManager fragmentManager,
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        mFragmentMaxLifecycleEnforcer = new FragmentStateAdapterOverride.FragmentMaxLifecycleEnforcer();
    ...
    @NonNull
    @Override
    public final FragmentViewHolderOverride onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return FragmentViewHolderOverride.create(parent);
    }

    @Override
    public final void onBindViewHolder(final @NonNull FragmentViewHolderOverride holder, int position) {
    ...
    @Override
    public final void onViewAttachedToWindow(@NonNull final FragmentViewHolderOverride holder) {
        placeFragmentInViewHolder(holder);
        gcFragments();
    }
     ...
     */
    @SuppressWarnings("WeakerAccess") // to avoid creation of a synthetic accessor
    void placeFragmentInViewHolder(@NonNull final FragmentViewHolderOverride holder) {
    ...
    @Override
    public final void onViewRecycled(@NonNull FragmentViewHolderOverride holder) {
        final int viewHolderId = holder.getContainer().getId();
        final Long boundItemId = itemForViewHolder(viewHolderId); // item currently bound to the VH
        if (boundItemId != null) {
            removeFragment(boundItemId);
    ...
    @Override
    public final boolean onFailedToRecycleView(@NonNull FragmentViewHolderOverride holder) {
        /*
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        void register(@NonNull RecyclerView recyclerView) {
            ...
            mDataObserver = new FragmentStateAdapterOverride.DataSetChangeObserver() {
                @Override
